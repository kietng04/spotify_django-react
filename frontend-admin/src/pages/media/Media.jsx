            ...
            <div className="content_item">
              <div className="colum">
                <div className="media_actions">
                  <Button
                    label="Upload"
                    icon={<Icons.TbCloudUpload />}
                    className="sm"
                  />
                  <Button
                    label="Download"
                    icon={<Icons.TbCloudDownload />}
                    className="sm"
                  />
                  <Button
                    label="Create folder"
              ...
              <div className="column">
                <div className="media_filter_head">
                  ...
                  <div
                    className="add_folder media_icon"
                    onClick={handleFolderPlusClick}
                  >
                    <Icons.TbFolderPlus />
                  </div>
                  <Modal bool={isModalVisible} onClose={closeModal}>
                    <div className="modal-head">
                      <h2>Add folder</h2>
                      <Button label="create folder" className="sm" />
                    </div>
                  ...
                  <div className="media_filter">
                    ...
                    <div
                      className="media_filter_item media_icon"
                      onClick={handleMediaLayout}
                    >
                      <Icons.TbLayoutGrid />
                    </div>
                  </div>
              ...
              <div className="column">
                <div className={`media_${layout ? "grid" : "flex"}`}>
                  {updatedMedia.map((file, key) => (
                    <div
                      className="media_grid_item"
                      key={key}
                      onClick={() => handleSelectFolder(file.id)}
                    >
                      {file.type === "folder" ? (
                        <Icons.TbFolder />
                      ) : (
                      ...
                      <span className="media_item_date line_clamp">
                        {file.createdAt}
                      </span>
                    </div>
                  ))}
                  ...
                  <div className="media_preview_content">
                    ...
                    <div className="media_preview_content_item">
                      ...
                      <span className="line_clamp">
                        {fileDetails.modifyDate}
                      </span>
                    </div>
                  </div>
                  <Button label="Download" className="sm full" />
                </>
              )}
            </div>
          </div>
